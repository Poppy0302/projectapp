...
<body>
  ...
  <div class="container my-3 mb-5">
    <div class="col-lg-3 text-center bg-light my-3" style="margin:auto;border-top: 2px groove black;border-bottom: 2px groove black;">     
      <h2 class="text-center">รายการอาหาร</h2>
    </div>
    <div class="row">
          ...
          echo '<div class="col-xs-3 col-sm-3 col-md-3">
                  <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      ...
                      <a href="viewPizzaList.php?catid=' . $id . '" class="btn btn-primary">ดูทั้งหมด</a>
                    </div>
                  </div>
                </div>';
        }
