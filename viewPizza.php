    ...
    <div class="container my-4" id="cont">
        ...
        echo  '<div class="col-md-4">
            ...
            <div class="col-md-8 my-4">
                <h3>' . $pizzaName . '</h3>
                <h5 style="color: #ff0000">฿. '.$pizzaPrice. '/-</h5>
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <button type="submit" name="addToCart" class="btn btn-primary my-2">หยิบใส่ตะกร้า</button>';
                    }else {
                        echo '<a href="viewCart.php"><button class="btn btn-primary my-2">ไปที่ตะกร้าสินค้า</button></a>';
                    }
                }
                else{
                ...
                <div class="mx-4">
                    ...
                    <i class="fas fa-qrcode"></i>
                        <span>ดูพิซซ่าทั้งหมด</span>
                    </a>
                </div>
                <div class="mx-4">
                    <a href="index.php" class="active text-dark">
                    <i class="fas fa-qrcode"></i>
                        <span>ดูหมวดหมู่</span>
                    </a>
                </div>
            </div>'
        ?>
