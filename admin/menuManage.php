				...
				<div class="card mb-3">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<option hidden disabled selected value>เลือก</option>
                                <?php
							...
							<div class="form-group">
								...
								<small id="Info" class="form-text text-muted mx-3">กรุณาอัพโหลดเป็น .jpg</small>
							</div>
					</div>
					...
					<div class="card-footer">
						<div class="row">
							<div class="mx-auto">
								<button type="submit" name="createItem" class="btn btn-sm btn-primary"> บันทึก </button>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table table-bordered table-hover mb-0">
							<thead style="background-color: rgb(111 202 203);">
								<tr>
									...
									<th class="text-center" style="width:58%;">รายละเอียด</th>
									<th class="text-center" style="width:18%;">สถานะ</th>
								</tr>
							</thead>
							<tbody>
                            <?php
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<button type="submit" class="btn btn-success my-1" name="updateItemPhoto">อัพเดทรูปภาพ</button>
				</div>
		...
		<form action="partials/_menuManage.php" method="post">
            ...
            <div class="text-left my-2">
                <b><label for="desc">รายละเอียด</label></b>
                <textarea class="form-control" id="desc" name="desc" rows="2" required minlength="6"><?php echo $pizzaDesc; ?></textarea>
            </div>
            <input type="hidden" id="pizzaId" name="pizzaId" value="<?php echo $pizzaId; ?>">
            <button type="submit" class="btn btn-success" name="updateItem">บันทึก</button>
        </form>
      </div>
    </div>
  </div>
