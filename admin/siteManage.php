	...
	<div class="card col-lg-6 p-0">
		...
		<div class="card-body">
			<form action="partials/_siteManage.php" method="post">
                ...
                <div class="form-group">
                    <label for="contact" class="control-label">เบอร์โทรศัพท์ 1</label>
                    <input type="tel" class="form-control" id="contact1" name="contact1" value="' .$contact1. '" required>
                </div>
                <div class="form-group">
                    <label for="contact" class="control-label">เบอร์โทรศัพท์ 2</label>
                ...
                <center>
                    <button name="updateDetail" class="btn btn-info btn-primary btn-block col-md-2">บันทึก</button>
                </center>
            </form>
		</div>
	</div>';
