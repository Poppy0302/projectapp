                            ...
                            <div class="row justify-content-center">';
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        ...
                                        echo '<a href="viewCart.php"><button class="btn btn-primary mx-2">ดูเพิ่มเติม</button></a>';
                                    }
                                }
                                else{
                                ...
                                echo '</form>
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '"><button class="btn btn-primary">ดูเพิ่มเติม</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
