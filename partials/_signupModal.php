      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color: rgb(111 202 203);">
            <h5 class="modal-title" id="signupModal">สมัครสมาชิก</h5>
          ...
          <div class="modal-body">
            ...
            <p class="mb-0 mt-1">คุณมีบัญชีอยู่แล้ว? <a href="#" data-dismiss="modal" data-toggle="modal" data-target="#loginModal">เข้าสู่ระบบ</a>.</p>
          </div>
        </div>
      </div>
    </div>
